...
![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/08/08165856/temp15.png)
...
![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/08/08173645/temp18.png)

The structure of RCNN is as follows:

![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/08/09074634/temp21.png)
...
![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/08/08180531/temp20.png)
...
![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/08/09075841/temp23.png)
...
![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/08/08170519/temp16.png)

The final architecture of squeezeNet is as follows:

![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/08/09075613/temp22.png)
...
![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/08/08170908/temp17.png)
...
GAN is an entirely different breed of neural network architectures, in which a neural network is used to generate an entirely new image which is not present is the training dataset, but is realistic enough to be in the dataset. For example, below image is a breakdown of GANs are made of. I have covered [how GANs work in this article](https://www.analyticsvidhya.com/blog/2017/06/introductory-generative-adversarial-networks-gans/). Go through it if you are curious.

![img](https://cdn.analyticsvidhya.com/wp-content/uploads/2017/06/11000153/g1.jpg)
...
![img](https://miro.medium.com/max/60/1*F-PHNVI7wdcoYFDrA9pmGQ.jpeg?q=20)

![img](https://miro.medium.com/max/1500/1*F-PHNVI7wdcoYFDrA9pmGQ.jpeg)
...
After finishing the famous [Andrew Ng’s Machine Learning Coursera course](https://github.com/khanhnamle1994/machine-learning), I started developing interest towards neural networks and deep learning. Thus, I started looking at the best online resources to learn about the topics and found [Geoffrey Hinton’s Neural Networks for Machine Learning course](https://github.com/khanhnamle1994/neural-nets). If you are a machine learning practitioners or someone who wants to get into the space, you should really took this course. Geoffrey Hinton is without a doubt the godfather of the machine learning world. And he actually provided something extraordinary in this course. In this blog post, I want to share the **10** **neural network architectures** from the course that I believe any machine learning researchers should be familiar with to advance their work.

## **Top 10 Neural Network Architectures You Need to Know**

**1 — Perceptrons**

![img](https://miro.medium.com/max/60/1*MeeNxFHM2IHXfbOdl43Vdg.png?q=20)

![img](https://miro.medium.com/max/1600/1*MeeNxFHM2IHXfbOdl43Vdg.png)

Considered the first generation of neural networks, ***Perceptrons\*** are simply computational models of a single neuron. Perceptron was originally coined by Frank Rosenblatt in his paper, *“*[*The perceptron: a probabilistic model for information storage and organization in the brain*](http://www.ling.upenn.edu/courses/cogs501/Rosenblatt1958.pdf)*” (1956)* [1]*.* Also called *feed-forward neural network*, perceptron feeds information from the front to the back. Training perceptrons usually requires *back-propagation*, giving the network paired datasets of inputs and outputs. Inputs are sent into the neuron, processed, and result in an output. The error being back propagated is often some variation of the difference between the input and the output. Given that the network has enough hidden neurons, it can theoretically always model the relationship between the input and output. Practically their use is a lot more limited but they are popularly combined with other networks to form new networks.

![img](https://miro.medium.com/max/60/1*SHqqeXlV_N-UgHeY3Mhkiw.jpeg?q=20)

![img](https://miro.medium.com/max/300/1*SHqqeXlV_N-UgHeY3Mhkiw.jpeg)
...
![img](https://miro.medium.com/max/60/1*fff15QGBaTLVTWkXqcCVpQ.png?q=20)

![img](https://miro.medium.com/max/2000/1*fff15QGBaTLVTWkXqcCVpQ.png)
...
A ***Boltzmann Machine\*** is a type of stochastic recurrent neural network. It can be seen as the stochastic, generative counterpart of Hopfield nets. It was one of the first neural networks capable of learning internal representations, and is able to represent and solve difficult combinatoric problems. First introduced by Geoffrey Hinton and Terrence Sejnowski in *“*[*Learning and relearning in Boltzmann machines*](https://papers.cnl.salk.edu/PDFs/Learning and Relearning in Boltzmann Machines 1986-3239.pdf)*” (1986)* [7]*,* Boltzmann machines are a lot like Hopfield Networks, but some neurons are marked as input neurons and others remain “hidden”. The input neurons become output neurons at the end of a full network update. It starts with random weights and learns through back-propagation. Compared to a Hopfield Net, the neurons mostly have binary activation patterns.
...
![img](https://miro.medium.com/max/60/1*iX-z3YCSFYx6GLxtPo7s4A.jpeg?q=20)

![img](https://miro.medium.com/max/960/1*iX-z3YCSFYx6GLxtPo7s4A.jpeg)

An efficient mini-batch learning procedure was proposed for Boltzmann Machines by [Salakhutdinov and Hinton in 2012](http://proceedings.mlr.press/v5/salakhutdinov09a/salakhutdinov09a.pdf) [8].
...
I hope that this post helps you learn the core concepts of neural networks, including modern techniques for deep learning. You can get all the lecture slides, research papers and programming assignments I have done for Dr. Hinton’s Coursera course [from my GitHub repo here](https://github.com/khanhnamle1994/neural-nets). Good luck studying!
