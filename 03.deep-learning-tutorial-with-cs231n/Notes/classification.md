...
<font color=blue> Note：For the specific tasks performed by robots, the NNC may be an useful method for finding a  particular object or moving to a desired position defined by a picture. </font>
